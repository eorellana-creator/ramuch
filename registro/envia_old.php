...
//if ($responseKeys["success"]) {
    ...
    if ($nombre != "" && $rut != "" && $email != "" && $telefono != "" && $password != "") {
        ...
        $headers    = "From: no-responder@ramuch.cl\r\n";
        $headers   .= "Reply-To: directiva@ramuch.cl\r\n";
        ...
        $headers .= "From: no-responder@ramuch.cl\r\n";
        $headers .= "Reply-To: no-responder@ramuch.cl\r\n";
...
//} else {
    // Token reCAPTCHA v3 inválido, detener el procesamiento del formulario
//    echo "Error: Token de reCAPTCHA v3 inválido.";
//}
?>
