...
<div  id="contenido">
                          ...
                          <div class="g-recaptcha" data-sitekey="6Ldsrc0pAAAAAFINb8eGvyLZNUv8OnpyqWzOxWtW"></div>
                          -->
...
function enviar(){
  ...
  function ejecutarRecaptcha() {
    grecaptcha.ready(function() {
      grecaptcha.execute('6Ldsrc0pAAAAAFINb8eGvyLZNUv8OnpyqWzOxWtW', {action: 'submit'}).then(function(token) {
        // Agrega el token al campo de formulario oculto
