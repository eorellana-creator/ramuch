...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220329_ramademontanaudechile_f9b7bb4aa4e560452577_20220801002719_archive.zip';
	const ARCHIVE_SIZE		 = '388490745';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f9b7bb4-01002719';
    const SECONDARY_PACKAGE_HASH = '4eb2b2d-01002719';
	const VERSION			 = '1.4.4';
