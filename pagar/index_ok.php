...
<br> 
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input id="rut" name="rut" class="form-control" type="text" value="<?php echo $rut;?>" placeholder="Tu Rut. Ej: 14.231.123-k" onBlur="elimina_slash(this);elimina_comillas(this);elimina_blancos_inicio_fin(this);" >
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="email" class="form-control" name="mail" id="mail" value="<?php echo $email;?>" placeholder="Tu correo para notificar el pago" value="" onBlur="elimina_slash(this);elimina_comillas(this);elimina_blancos_inicio_fin(this);" maxlength="255"  >
...
/*
  ...
  var totalDeuda = parseInt(valor)*2;
*/
//kop
