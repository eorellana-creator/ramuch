                    ...
                    <div class="col-md-6">
                      <div class="card mx-4">
                        <div class="card-body p-4">
                          ...
                          <p class="text-muted">disculpe las molestias</p>
...
<br> 
                          ...
                          <div class="input-group mb-3">
                           En este momento estamos en mantención para el sistema de pagos. Volvemos después de las 14:00 hrs
                          </div>
...
<br> <br>
                          <button class="btn btn-block btn-success"  type="button">Estamos en mantención</button>
                        </div>
                        ...
                        <div class="card-footer p-4">
                          <div class="row">
                            <div class="col-6">
                              <a href="http://www.montanauchile.cl/">
