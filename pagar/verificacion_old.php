...
$sql 	= $mysql->query("UPDATE deudas SET estado='activa' WHERE id_usuario_deuda='$result->id_usuario' AND estado='por confirmar' AND sub_cuenta='matricula' ; ");


$mensaje = "<br> <br><h3>Gracias por completar tu registro.</h3> <br>Ahora puedes acceder al sistema de socios de Ramuch.<br> <br> <br> <a href='../socios'><button class='btn btn-block btn-primary' type='button'>Acceder al Sistema</button></a> <br> <br> <br>";
}//if($existe>0)
                    ...
                    <div class="col-md-6">
                      <div class="card mx-4">
                        <div class="card-body p-4">
                          <h1><img src="images/tf.png" alt="Logo Transportes Fuentes" > &nbsp;Ramuch</h1>
...
$('#contenido').html("<div style='width:100%; text-align: center; padding-top:30px;padding-bottom:90px'><strong><br>Hemos enviado un email a tu correo para que verifiques tu cuenta antes de acceder. Sigue las instrucciones y terminarás tu registro.<br><br>Muchas Gracias.<br>Transportes Fuentes.</strong><br><br></div>");
