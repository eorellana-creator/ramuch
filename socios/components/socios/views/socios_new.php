    ...
    <div class="card-body">
        ...
        <form name="formulario" id="formulario" method="post" action="javascript: enviar();" enctype="multipart/form-data">
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <!-- Historial de Préstamos Tab - VERSIÓN RESPONSIVA -->
                <div class="tab-pane fade" id="nav-prestamo" role="tabpanel" aria-labelledby="nav-prestamo-tab">
                    ...
                    @media (max-width: 767px) {
                        ...
                        #tablaprestamos th, #tablaprestamos td {
                            padding: 6px 4px;
                        }
                        .btn-prestamo-mobile {
                            padding: 4px 8px;
                                ...
                                <div class="card">
                                    <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                                        <div class="d-flex align-items-center mb-2 mb-md-0">
                                            ...
                                            <span class="font-weight-bold">Historial de Préstamos</span>
                                        </div>
                                        <div class="d-flex flex-wrap">
                                            <a href="index.php?component=equipo&view=equipo_list" class="btn btn-primary btn-sm mr-2 mb-2">
                                                <i class="fas fa-plus mr-1"></i> Pedir equipo
                                            </a>
                                            <button type="button" class="btn btn-warning btn-sm mb-2" onclick="cargarAtrasos()">
                                                <i class="fas fa-exclamation-triangle mr-1"></i> Ver atrasos
                                            </button>
                                        </div>
                                    </div>
                                    <div class="card-body p-0">
                                        <div id="tabla-prestamos-container">
                                            <table id="tablaprestamos" class="table table-striped table-bordered mb-0" style="width:100%;">
                                                <thead class="thead-dark">
                                                    <tr>
                                                        <th class="text-center" style="min-width: 40px;">#</th>
                                                        <th style="min-width: 150px;">Equipo</th>
                                                        <th style="min-width: 100px;">Fecha Préstamo</th>
                                                        <th style="min-width: 120px;">Fecha compromiso</th>
                                                        <th style="min-width: 120px;">Fecha devolución</th>
                                                        <th class="d-none d-md-table-cell" style="min-width: 150px;">Responsables</th>
                                                        <th class="d-none d-lg-table-cell" style="min-width: 150px;">Observación</th>
                                                        <th style="min-width: 120px;">Estado devolución</th>
                                                        <th style="min-width: 120px;">Estado Solicitud</th>
                                        ...
                                        <div class="alert alert-info d-md-none m-3">
                                            <small>
                                                ...
                                                <strong>Nota para dispositivos móviles:</strong> Desliza horizontalmente para ver todas las columnas de la tabla.
                                            </small>
                                        </div>
                                    </div>
                                </div>
...
$(document).ready(function() {
    if ($.fn.DataTable) {
        $('#tablaprestamos').DataTable({
            "responsive": false, // Desactivamos responsive de DataTables porque usamos el nuestro
            "autoWidth": false,
            "scrollX": true,
            "language": {
            ...
            "columnDefs": [
                ...
                {
                    "targets": [5, 6], // Columnas ocultas en móviles
                    "visible": true // DataTables las mostrará, pero CSS las oculta en móviles
                },
                {
            ...
            "order": [[2, 'desc']], // Ordenar por fecha de préstamo descendente
            "pageLength": 10,
            "lengthMenu": [[5, 10, 25, 50, -1], [5, 10, 25, 50, "Todos"]]
        });
    }
    
    // Función para ajustar tabla en redimensionamiento
    $(window).on('resize orientationchange', function() {
        if ($.fn.DataTable && $.fn.DataTable.isDataTable('#tablaprestamos')) {
            $('#tablaprestamos').DataTable().columns.adjust();
        }
    });
});

// Función de ejemplo para devolver equipo (debes implementarla)
function devolverEquipo(token) {
    Swal.fire({
        title: '¿Devolver equipo?',
        text: "¿Estás seguro que deseas marcar este equipo como devuelto?",
        icon: 'question',
        ...
        if (result.isConfirmed) {
            // Aquí iría tu lógica AJAX para devolver el equipo
            Swal.fire(
                '¡Devuelto!',
...
// Función de ejemplo para ver detalle (debes implementarla)
function verDetallePrestamo(token) {
    Swal.fire({
        title: 'Detalle del préstamo',
        html: 'Aquí mostrarías los detalles del préstamo con token: ' + token,
        icon: 'info'
    });
}

// Función de ejemplo para cancelar solicitud (debes implementarla)
function cancelarSolicitud(token) {
    Swal.fire({
        title: '¿Cancelar solicitud?',
        text: "¿Estás seguro que deseas cancelar esta solicitud de préstamo?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        ...
        if (result.isConfirmed) {
            // Aquí iría tu lógica AJAX para cancelar la solicitud
            Swal.fire(
                '¡Cancelada!',
