...
while($result = $mysql->f_obj($sql)) {
    ...
    $datos[] = array(
        ...
        htmlspecialchars($result->marca ?? ''), //htmlspecialchars($result->marca),
        $result->estado,
        "",
        ""
        //"<button type='button' class='btn btn-primary edit-product' data-product-id='$result->id'> <i class='fas fa-edit'></i> Editar </button>",
