...
//if($id_usuario=="1773")
//echo "SELECT * FROM perfil WHERE id_usuario='$id_usuario' AND (tipo_inscripcion='1' OR tipo_inscripcion='3') ;<br>";
...
mail('maudichili@gmail.com', 'Cron Ramuch', "El cron se encuentra tranajando");
