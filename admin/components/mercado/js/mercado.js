...
function limpiarPrecio(precio) {
    ...
    /*
    console.log('Valor de entrada:', precio); // Depuración: Verificar el valor de entrada
    // Eliminar todos los puntos (separadores de miles)
    let precioLimpio = precio.replace(/\./g, '');
    console.log('Después de eliminar puntos:', precioLimpio); // Depuración: Verificar después de eliminar puntos

    // Reemplazar la coma por un punto para manejar decimales
    precioLimpio = precioLimpio.replace(',', '.');
    console.log('Después de reemplazar coma:', precioLimpio); // Depuración: Verificar después de reemplazar coma

    // Convertir a número y redondear para eliminar decimales
    //let precioNumerico = parseFloat(precioLimpio);
    //console.log('Después de parseFloat:', precioNumerico); // Depuración: Verificar después de parseFloat

    //let precioRedondeado = Math.round(precioNumerico);
    //console.log('Después de Math.round:', precioRedondeado); // Depuración: Verificar después de redondear
