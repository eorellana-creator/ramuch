...
$(document).ready(function() {
    ...
    $('#tabla').DataTable( {
        ...
        "ajax": {
            "url": "components/egresos/models/egresos_list_procesa.php",
            "type": "POST"
        }
...
function enviar(){
    ...
    if(error=="1"){
        ...
        url	= "components/egresos/models/insert_update.php";
        ...
        $.ajax({
           ...
           document.location.href="index.php?component=egresos&view=egresos&token="+token;
...
$.ajax({
  type: 'POST',
  url: "components/egresos/models/delete_egreso.php",
  data:  "token="+token,
  success: function(resp){
		...
		if(resultado=="1"){
                    ...
                    message: "El egreso se ha eliminado.",
                    ...
                    action: function(dialogItself){
                           ...
                           document.location.reload();
                            ...
                            BootstrapDialog.alert("No se puede eliminar el egreso del sistema. Existen datos relacionado al item.");
                        }
...
$.ajax({
  type: 'POST',
  url: "components/egresos/models/delete_documento.php",
  data:  "token="+token,
  success: function(resp){
		var retorno = resp.split('|');
		var resultado = retorno[1];
