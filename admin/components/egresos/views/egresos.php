...
<div class="card">
    <div class="card-header"><i class="fas fa-sign-out-alt"></i> Egreso</div>
        <div class="card-body">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-lg-3 form-group"> 
                    <label class="col-form-label"><span class="obligatorio">*</span>Destinatario del Egreso:</label>
                    <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Destinatario del Egreso"  value="<?php echo @$result->nombre;?>" onBlur="elimina_slash(this);elimina_comillas(this);elimina_blancos_inicio_fin(this);"  maxlength="100" >
                </div>


                <div class="col-lg-3 form-group"> 
                    <label class="col-form-label"><span class="obligatorio">*</span>Motivo del Egreso:</label>
                    <input type="text" class="form-control" name="glosa" id="glosa" placeholder="Motivo del Egreso"  value="<?php echo @$result->glosa;?>" onBlur="elimina_slash(this);elimina_comillas(this);elimina_blancos_inicio_fin(this);"  maxlength="100" >
                </div>



                <div class="col-lg-2 form-group"> 
                                <label class="col-form-label"><span class="obligatorio">*</span>Fecha del Egreso:</label>
                                <input class="form-control" id="fecha" type="date" name="fecha" placeholder="date" value="<?php echo @$result->fecha;?>">
                </div>


                <div class="col-lg-2 form-group"> 
                    <label class="col-form-label"><span class="obligatorio">*</span>Monto del Egreso:</label>
                ...
                <div class="col-lg-6 form-group"> 
                    <label class="col-form-label">Observación del Egreso:</label>
                ...
                <div class="col-lg-12 text-center">
                    <br>
                        <a href="index.php?component=egresos&view=all"><button type="button" class="btn btn-secondary" style="margin-top:10px; width:180px;margin-right:10px;"> ir al listado de egresos </button></a>
                      
                        <button type="submit" class="btn btn-primary" style="margin-top:10px;width:180px;margin-right:10px;"> Guardar Egreso </button>
						<br> <br>  <br> 
                </div>
