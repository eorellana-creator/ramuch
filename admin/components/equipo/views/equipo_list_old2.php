...
// Código de diagnóstico - agregar al final de tu script
console.log('Script cargado - verificando elementos...');
...
$(document).ready(function() {
    ...
    // Agregar evento de clic con diagnóstico
    $('#btnEquiposAtraso').on('click', function() {
        console.log('Botón clickeado');
        console.log('Mostrando modal...');
        
        // Intentar mostrar el modal de diferentes formas
        try {
            $('#modalAtraso').modal('show');
            console.log('Modal mostrado (método 1)');
        } catch (e) {
            console.error('Error método 1:', e);
            try {
                var modal = new bootstrap.Modal(document.getElementById('modalAtraso'));
                modal.show();
                console.log('Modal mostrado (método 2)');
            } catch (e2) {
...
// Función original para equipos con atraso
$('#btnEquiposAtraso').click(function() {
...
// Mostrar modal de equipos con atraso
$('#btnEquiposAtraso').click(function() {
    // Establecer fechas por defecto (últimos 30 días)
    var fechaFin = new Date();
    var fechaInicio = new Date();
...
// Función para filtrar equipos con atraso
function filtrarEquiposAtraso() {
    ...
    $.ajax({
        ...
        error: function() {
            $('#cuerpoTablaAtraso').html('<tr><td colspan="9" class="text-center text-danger">Error al cargar los datos</td></tr>');
        }
    });
}
