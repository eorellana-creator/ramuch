<script> 
function aceRec(accion, token) {
            $.ajax({
                url: 'equipo_solicitudes_list_procesa.php',
                type: 'POST',
                data: {
                    accion: accion,
                    token: token
                ...
                success: function(response) {
                    if (response == 'success') {
                        $('#btn-aceptar-' + token).prop('disabled', true);
                        $('#btn-rechazar-' + token).prop('disabled', true);
                    } else {
...
<?php echo $mensaje;?>
      <div class="card">
         <div class="card-header">
                 <i class="fas fa-hiking"></i> <strong>Equipos Solicitados</strong> &nbsp; &nbsp; 
