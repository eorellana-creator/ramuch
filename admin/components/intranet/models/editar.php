...
if (!$item || $item->estado !== 'solicitado') {
...
$mysql->query("INSERT INTO intranet_solicitud_historial (id_solicitud,id_usuario,usuario_nombre,accion,estado_anterior,estado_nuevo,comentario,fecha) VALUES ('$item->id_solicitud','$idUsuarioIntranet','$nombre','editar','solicitado','solicitado','$comentarioHistorial','$ahora');");
$mysql->query('COMMIT');
