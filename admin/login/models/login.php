...
if($accion == "login"){ //ingresar
	$sql 	= $mysql->query("SELECT u.token           usuario_token,
							...
							and u.email = '$email' and u.estado='Vigente' and (u.id_rol='11' OR u.id_rol='1' OR u.id_rol='5' OR u.id_rol='6' OR u.id_rol='7'  )   						
	...
	if($cantidad>0){
		...
		$sql2 	= $mysql->query("SELECT img_perfil FROM perfil WHERE id_usuario='$result->usuario_id';");
		$result2 = $mysql->f_obj($sql2);


		$imagen_perfil = "images/user_no.png";
		if(@$result2->img_perfil!="")
		$imagen_perfil = "images/img_perfil/$result2->img_perfil";
