...
<head>
    ...
    <meta name="description" content="Sistema optimizado By Kop">
        ...
        <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <?php include("components/menu_config/menu_config.php"); ?>
        ...
        <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <?php include("components/menu/menu_lateral.php"); ?>
                </ul>
            </nav>
